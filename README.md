...
`${GOPATH}/src/github.com/swlee3306/oskindbeat`
...
```
git remote set-url origin https://github.com/swlee3306/oskindbeat
...
in the same directory with the name oskindbeat.
...
```
./oskindbeat -c oskindbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/swlee3306/oskindbeat
git clone https://github.com/swlee3306/oskindbeat ${GOPATH}/src/github.com/swlee3306/oskindbeat
```
